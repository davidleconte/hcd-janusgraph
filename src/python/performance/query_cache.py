...
class QueryCache:
    ...
    def _evict_one(self):
        ...
        if self.strategy == CacheStrategy.LRU:
            ...
            key_to_evict = min(self.cache.keys(), key=lambda k: self.cache[k].last_accessed)
...
class CachedQueryExecutor:
    ...
    def execute(
        ...
        **kwargs,
        ...
        # Cache result
        self.cache.set(cache_key, result, ttl_seconds=ttl_seconds, dependencies=dependencies)
...
if __name__ == "__main__":
    ...
    # Initialize cache
    cache = QueryCache(max_size_mb=50, default_ttl_seconds=300, strategy=CacheStrategy.LRU)
