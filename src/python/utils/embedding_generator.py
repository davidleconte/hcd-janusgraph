...
class EmbeddingGenerator:
    ...
    def encode_for_search(self, query: str, normalize: bool = True) -> np.ndarray:
        """
...
def encode_person_name(name: str, generator: Optional[EmbeddingGenerator] = None) -> np.ndarray:
    """
...
def encode_transaction_description(
    description: str, generator: Optional[EmbeddingGenerator] = None
) -> np.ndarray:
    """
...
def encode_sanctions_list(
    names: List[str], generator: Optional[EmbeddingGenerator] = None, batch_size: int = 32
) -> np.ndarray:
    """
    ...
    return generator.encode(normalized_names, batch_size=batch_size, show_progress=True)
...
if __name__ == "__main__":
    ...
    print("✅ Fuzzy matching works! Similar names have higher similarity.")
