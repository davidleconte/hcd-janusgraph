...
try:
    ...
    gc.submit("""
        ...
        g.V(alice).addE('knows').to(g.V(bob)).property('since', 2018)
         .V(alice).addE('knows').to(g.V(carol)).property('since', 2019)
         .V(alice).addE('knows').to(g.V(david)).property('since', 2020)
         .V(bob).addE('knows').to(g.V(david)).property('since', 2019)
         .V(carol).addE('knows').to(g.V(eve)).property('since', 2017)
         .V(david).addE('knows').to(g.V(eve)).property('since', 2021)
         .iterate()
    """).all().result()
    time.sleep(1)
    ...
    gc.submit("""
        ...
        g.V(alice).addE('worksFor').to(g.V(datastax)).property('role', 'Senior Engineer').property('since', 2018)
         .V(bob).addE('worksFor').to(g.V(acme)).property('role', 'Product Manager').property('since', 2020)
         .V(carol).addE('worksFor').to(g.V(datastax)).property('role', 'Director').property('since', 2016)
         .V(david).addE('worksFor').to(g.V(datastax)).property('role', 'Engineer').property('since', 2021)
         .V(eve).addE('worksFor').to(g.V(techstart)).property('role', 'CTO').property('since', 2018)
         .iterate()
    """).all().result()
    time.sleep(1)
    ...
    gc.submit("""
        ...
        g.V(datastax).addE('created').to(g.V(janusgraph)).property('since', 2017)
         .V(acme).addE('created').to(g.V(cloudService)).property('since', 2019)
         .V(techstart).addE('created').to(g.V(analyticsEngine)).property('since', 2020)
         .iterate()
    """).all().result()
    time.sleep(1)
    ...
    gc.submit("""
        ...
        g.V(alice).addE('uses').to(g.V(janusgraph)).property('since', 2019)
         .V(bob).addE('uses').to(g.V(cloudService)).property('since', 2020)
         .V(carol).addE('uses').to(g.V(janusgraph)).property('since', 2018)
         .V(david).addE('uses').to(g.V(janusgraph)).property('since', 2021)
         .V(eve).addE('uses').to(g.V(analyticsEngine)).property('since', 2020)
         .iterate()
    """).all().result()
