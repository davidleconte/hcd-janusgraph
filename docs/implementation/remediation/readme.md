...
This directory contains active remediation tracking and issue resolution documentation.
...
Historical and completed remediation documents have been archived to:
- **[Local archive/](archive/)** - Directory-specific historical remediation
- **[Project archive](../../archive/2026-02/remediation/)** - Project-wide obsolete remediation plans
