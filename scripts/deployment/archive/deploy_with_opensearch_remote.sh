...
# Step 7: Start OpenSearch (before JanusGraph - it may use it as index backend)
echo "7. Starting OpenSearch..."
...
# Step 8: Install JVector plugin
echo "8. Installing JVector plugin..."
...
echo "9. Starting all remaining services..."
...
# Step 11: Validate services on remote machine
echo "11. Validating services on remote machine..."
...
echo "🛑 TO STOP:"
echo "   cd config/compose"
echo "   CONTAINER_HOST=$CONTAINER_HOST podman-compose -p $COMPOSE_PROJECT_NAME -f docker-compose.full.yml down"
echo "   CONTAINER_HOST=$CONTAINER_HOST podman-compose -p $COMPOSE_PROJECT_NAME -f docker-compose.banking.yml down"
echo ""
echo "🔐 CREDENTIALS:"
