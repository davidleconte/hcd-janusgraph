// JanusGraph Sample Schema Initialization
// Creates a simple property graph schema for a social network
...
// Mixed Indexes (for full-text and range queries) - using Lucene
...
println ""
println "Graph closed. Schema initialization complete."
