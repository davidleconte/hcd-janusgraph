...
class TestValidatorIBAN:
    ...
    @pytest.mark.parametrize("iban,is_valid", [
...
class TestValidatorSWIFT:
    ...
    @pytest.mark.parametrize("swift,is_valid", [
        ("DEUTDEFF", True),
        ("DEUTDEFFXXX", True),
        ("BNPAFRPP", True),
        ("INVALID", False),
...
class TestValidatorSSN:
    ...
    @pytest.mark.parametrize("ssn,is_valid", [
        ("123-45-6789", True),
        ("123456789", True),
...
class TestValidatorCurrency:
    ...
    @pytest.mark.parametrize("currency,is_valid", [
        ("USD", True),
        ("EUR", True),
        ("GBP", True),
        ("JPY", True),
