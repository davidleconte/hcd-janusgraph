...
class VectorConsumer:
    ...
    def __init__(
        ...
        self.opensearch_host = opensearch_host or os.getenv('OPENSEARCH_HOST', self.DEFAULT_OPENSEARCH_HOST)
        self.opensearch_port = opensearch_port or int(os.getenv('OPENSEARCH_PORT', self.DEFAULT_OPENSEARCH_PORT))
