...
class TestMockEntityProducer:
    ...
    def test_flush(self):
        ...
        producer = MockEntityProducer()
        producer.send(
            EntityEvent(entity_id="test", event_type="create", entity_type="person", payload={})
        )
...
class TestProducerIntegration:
    ...
    def test_batch_mixed_entity_types(self):
        ...
        events = [
            EntityEvent(
                entity_id="p1", event_type="create", entity_type="person", payload={"name": "John"}
            ),
            EntityEvent(
                entity_id="a1",
                event_type="create",
            ...
            EntityEvent(
                entity_id="c1", event_type="create", entity_type="company", payload={"name": "ACME"}
            ),
            EntityEvent(
                entity_id="t1",
                event_type="create",
