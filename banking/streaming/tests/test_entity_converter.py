...
class TestEntityToDict:
    ...
    def test_dataclass_conversion(self):
        ...
        person = MockPerson(
            id="p-123", first_name="John", last_name="Doe", email="john@example.com"
        )
    ...
    def test_pydantic_model_conversion(self):
        ...
        person = PydanticPerson(
            id="p-456", first_name="Jane", last_name="Smith", email="jane@example.com"
        )
        result = entity_to_dict(person)
...
class TestGetEntityId:
    ...
    def test_transaction_id_field(self):
        ...
        txn = MockTransaction(
            transaction_id="t-789", amount=100.0, from_account="a-1", to_account="a-2"
        )
    ...
    def test_communication_id_field(self):
        ...
        comm = MockCommunication(
            communication_id="comm-202", sender_id="p-1", recipient_id="p-2", content="Hello"
        )
...
class TestGetEntityType:
    ...
    def test_transaction_type(self):
        ...
        txn = MockTransaction(
            transaction_id="t-1", amount=50.0, from_account="a-1", to_account="a-2"
        )
    ...
    def test_communication_type(self):
        ...
        comm = MockCommunication(
            communication_id="cm-1", sender_id="p-1", recipient_id="p-2", content="Hi"
        )
...
class TestConvertEntityToEvent:
    ...
    def test_transaction_conversion(self):
        ...
        txn = MockTransaction(
            transaction_id="t-789", amount=1500.0, from_account="a-1", to_account="a-2"
        )
...
class TestConvertEntitiesToEvents:
    ...
    def test_batch_conversion(self):
        ...
        persons = [
            MockPerson(
                id=f"p-{i}", first_name=f"Person{i}", last_name="Test", email=f"p{i}@test.com"
            )
            for i in range(5)
        ]
    ...
    def test_batch_with_source(self):
        ...
        companies = [
            MockCompany(company_id=f"c-{i}", name=f"Company{i}", industry="Tech") for i in range(2)
        ]
