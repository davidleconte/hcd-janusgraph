...
# Data models
from ..utils.data_models import Account, Communication, Company, Pattern, Person, Transaction
...
class GenerationStats:
    ...
    def finalize(self):
        ...
        self.total_records = (
            ...
            + self.companies_generated
            + self.accounts_generated
            + self.transactions_generated
            + self.communications_generated
            + self.trades_generated
            + self.travels_generated
