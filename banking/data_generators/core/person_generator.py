...
from ..utils.constants import COUNTRIES, HIGH_RISK_COUNTRIES, PEP_CATEGORIES, SANCTIONS_LISTS
...
class PersonGenerator(BaseGenerator[Person]):
    ...
    def generate(self) -> Person:
        ...
        risk_level = self._calculate_risk_level(is_pep, is_sanctioned, nationality, annual_income)
    ...
    def _generate_phone_numbers(
        self, nationality: str, count: Optional[int] = None
    ) -> List[PhoneNumber]:
    ...
    def _generate_email_addresses(
        self, first_name: str, last_name: str, count: Optional[int] = None
    ) -> List[EmailAddress]:
    ...
    def _generate_identification_documents(
        self, nationality: str, dob: date
    ) -> List[IdentificationDocument]:
    ...
    def _calculate_net_worth(
        self, annual_income: Optional[Decimal], dob: date
    ) -> Optional[Decimal]:
    ...
    def _calculate_risk_level(
        self, is_pep: bool, is_sanctioned: bool, nationality: str, annual_income: Optional[Decimal]
    ) -> RiskLevel:
        """Calculate risk level."""
    ...
    def _generate_education_level(self) -> str:
        ...
        levels = ["high_school", "associate", "bachelor", "master", "doctorate", "professional"]
