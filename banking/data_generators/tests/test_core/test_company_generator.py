...
class TestCompanyGeneratorFunctional:
    ...
    def test_industry_valid(self, sample_companies):
        ...
        valid_industries = [
            'financial_services', 'technology', 'healthcare', 'retail',
            'manufacturing', 'real_estate', 'energy', 'telecommunications',
            'transportation', 'hospitality', 'agriculture', 'construction',
            'education', 'entertainment', 'legal', 'consulting'
        ]
        for company in sample_companies:
