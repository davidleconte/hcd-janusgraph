...
class TestConversationThreads:
    ...
    def test_generate_thread(self):
        ...
        thread = generator.generate_conversation_thread(
            sender_id=sender, recipient_id=recipient, message_count=5
        )
    ...
    def test_thread_alternates_sender(self):
        ...
        thread = generator.generate_conversation_thread(
            sender_id=sender, recipient_id=recipient, message_count=4
        )
    ...
    def test_thread_chronological_order(self):
        ...
        thread = generator.generate_conversation_thread(
            sender_id="PER-12345678", recipient_id="PER-87654321", message_count=5
        )
...
class TestRiskScoring:
    ...
    def test_multiple_factors_increase_risk(self):
        ...
        comm = generator.generate(force_suspicious=True, communication_type=CommunicationType.EMAIL)
