...
class TestTransactionGeneratorReproducibility:
    ...
    @pytest.mark.skip(reason="Faker library does not guarantee deterministic output across separate instances even with same seed. This is a known limitation.")
