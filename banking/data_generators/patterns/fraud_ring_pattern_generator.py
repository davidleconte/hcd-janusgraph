    ...
    def generate(
        ...
        return Pattern(
            ...
            metadata={
                ...
                "transaction_velocity": len(transactions) / duration_days if duration_days > 0 else 0,
        ...
        for i in range(transaction_count):
            ...
            if pattern_type == "money_mule_network":
                ...
                if random.random() < 0.7:
                    ...
                    from_acc = hub_account if random.random() < 0.5 else random.choice(account_ids[1:])
                    to_acc = random.choice(account_ids[1:]) if from_acc == hub_account else hub_account
                else:
                    # Peer-to-peer
