...
class StructuringPatternGenerator(BaseGenerator[Pattern]):
    ...
    def _generate_structuring_transactions(
        ...
        for i in range(count):
            ...
            txn = self.txn_gen.generate(from_account_id=account_id, force_structuring=True)
    ...
    def _generate_indicators(
        self, pattern_type: str, transactions: List[Any], smurf_count: int
    ) -> List[str]:
        """Generate indicators."""
    ...
    def _generate_red_flags(
        self, pattern_type: str, transactions: List[Any], total_value: Decimal
    ) -> List[str]:
        """Generate red flags."""
