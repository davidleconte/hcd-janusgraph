...
def main():
    ...
    print(f"  Annual Income: ${person.annual_income:,.2f}" if person.annual_income else "  Annual Income: N/A")
    ...
    print(f"  Employees: {company.employee_count:,}" if company.employee_count else "  Employees: N/A")
    print(f"  Revenue: ${company.annual_revenue:,.2f}" if company.annual_revenue else "  Revenue: N/A")
