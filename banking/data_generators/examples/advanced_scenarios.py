...
def scenario_1_comprehensive_financial_crime():
    ...
    print(f"  Events: {config.transaction_count + config.communication_count + config.trade_count:,}")
    print(f"  Patterns: {config.insider_trading_patterns + config.tbml_patterns + config.fraud_ring_patterns + config.structuring_patterns + config.cato_patterns}")
    ...
    print(f"  Throughput: {(stats.persons_generated + stats.companies_generated + stats.accounts_generated) / stats.duration_seconds:.0f} entities/sec")
...
def scenario_2_insider_trading_focus():
    ...
    print(f"\nConfiguration:")
    print(f"  Focus: Insider Trading Detection")
    ...
    print(f"\nGeneration Complete!")
    print(f"  Total Entities: {stats.persons_generated + stats.companies_generated + stats.accounts_generated:,}")
    print(f"  Trades: {stats.trades_generated:,}")
    print(f"  Communications: {stats.communications_generated:,}")
...
def scenario_3_money_laundering_network():
    ...
    print(f"\nConfiguration:")
    print(f"  Focus: Money Laundering Detection")
...
def scenario_5_performance_benchmark():
    ...
    print(f"\nConfiguration:")
    print(f"  Focus: Performance Benchmark")
    print(f"  Total Entities: {config.person_count + config.company_count + config.account_count:,}")
    print(f"  Total Events: {config.transaction_count + config.communication_count + config.trade_count + config.travel_count + config.document_count:,}")
    print(f"  Total Patterns: {config.insider_trading_patterns + config.tbml_patterns + config.fraud_ring_patterns + config.structuring_patterns + config.cato_patterns}")
    ...
    print(f"\nGeneration Complete!")
    print(f"  Total Entities: {stats.persons_generated + stats.companies_generated + stats.accounts_generated:,}")
    print(f"  Total Events: {stats.transactions_generated + stats.communications_generated + stats.trades_generated + stats.travels_generated + stats.documents_generated:,}")
    print(f"  Total Patterns: {stats.patterns_injected}")
    print(f"  Duration: {duration:.2f}s")
    print(f"\nPerformance Metrics:")
    print(f"  Entity Throughput: {(stats.persons_generated + stats.companies_generated + stats.accounts_generated) / duration:.0f} entities/sec")
    print(f"  Event Throughput: {(stats.transactions_generated + stats.communications_generated + stats.trades_generated) / duration:.0f} events/sec")
    print(f"  Overall Throughput: {(stats.persons_generated + stats.companies_generated + stats.accounts_generated + stats.transactions_generated) / duration:.0f} items/sec")
