...
class TradeGenerator(BaseGenerator[Trade]):
    ...
    def generate(
        ...
        if asset_type is None:
            asset_type = random_choice_weighted(
                list(self.asset_type_weights.items())
            )
    ...
    def _get_exchange_currency(self, exchange: str) -> str:
        ...
        exchange_currencies = {
            "NYSE": "USD", "NASDAQ": "USD", "LSE": "GBP", "TSE": "JPY",
            "HKEX": "HKD", "SSE": "CNY", "SZSE": "CNY", "Euronext": "EUR",
            "TSX": "CAD", "ASX": "AUD", "BSE": "INR", "NSE": "INR",
            "BMV": "MXN", "B3": "BRL", "JSE": "ZAR", "KRX": "KRW"
        }
