...
class ImprovedAMLLoader:
    ...
    def create_vertex(self, label, properties):
        ...
        # Build query
        prop_str = "".join(
            [f".property('{k}', {self._format_value(v)})" for k, v in properties.items()]
        )
    ...
    def load_sample_data(self):
        ...
        self.create_vertex(
            "account",
            {"account_id": "ACC00000001", "account_type": "checking", "balance": 450000.0},
        )

        self.create_edge(
            "person", "person_id", "P000001", "owns_account", "account", "account_id", "ACC00000001"
        )

        print("  ✅ Beneficiary loaded")
        ...
        for mule in mules:
            ...
            self.create_vertex(
                "account",
                {"account_id": mule["acc"], "account_type": "checking", "balance": mule["bal"]},
            )
    ...
    def validate(self):
        ...
        counts = {
            ...
            "transaction": self.gc.submit("g.V().hasLabel('transaction').count()")
            .all()
            .result()[0],
        }
