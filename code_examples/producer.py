...
class TransactionProducer:
    ...
    def __init__(self, pulsar_url: str = "pulsar://localhost:6650"):
        ...
        """
        self.client = Client(pulsar_url, operation_timeout_seconds=30, connection_timeout_ms=10000)
    ...
    def send_transaction_event(self, transaction: Dict[str, Any]) -> None:
        ...
        event_timestamp = int(
            datetime.fromisoformat(transaction["timestamp"].replace("Z", "+00:00")).timestamp()
            * 1000
        )
